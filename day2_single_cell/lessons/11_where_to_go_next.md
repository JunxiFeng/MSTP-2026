...
4. **Integrating across studies** — once you have more than one dataset (different donors, different labs, different technologies), the batch-correction/integration methods you ran hands-on in [07_dimensionality_reduction_and_clustering.ipynb](07_dimensionality_reduction_and_clustering.ipynb) become necessary, not optional — today's Harmony section used two datasets specifically to make that point concrete rather than hypothetical.
